...
class Account(AbstractUser):
    ...
    is_blogger = fields.BooleanField(default=False)
    cash_balance = fields.DecimalField(min_value=0, default=0)
    asicoin_balance = fields.DecimalField(min_value=0, default=0)
