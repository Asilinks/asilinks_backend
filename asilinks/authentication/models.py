...
class AbstractUser(BaseUser, document.Document):
    ...
    first_name = fields.StringField(min_length=2,
        max_length=30, blank=True, verbose_name=_('first name'),
    )

    last_name = fields.StringField(min_length=2,
    ...
    @classmethod
    def _create_user(cls, email, password, create_superuser=False):
        ...
        user = cls(email=email, date_joined=now)
    ...
    def create_user(cls, email, password):
        return cls._create_user(email, password)

    @classmethod
    def create_superuser(cls, email, password):
        return cls._create_user(email, password, create_superuser=True)
